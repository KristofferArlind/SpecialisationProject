...
global_data = pd.read_csv('global_data_2009_2017.zip', dtype={'priusa': str, 'prican' : str, 'prirow' : str, 'iid' : str})
...
# In[ ]:
joined_data.to_csv('global_data_2010_to_2018_processed.zip', index=False)

# In[ ]:
joined_data[joined_data["date"].dt.year == 2018].to_parquet('global_data_2018only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2017].to_parquet('global_data_2017only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2016].to_parquet('global_data_2016only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2015].to_parquet('global_data_2015only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2014].to_parquet('global_data_2014only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2013].to_parquet('global_data_2013only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2012].to_parquet('global_data_2012only_processed.parquet', index=False)