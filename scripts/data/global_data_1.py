...
# In[]:
global_data = pd.read_csv('global_data_2017_2023.zip', dtype={'priusa': str, 'prican' : str, 'prirow' : str, 'iid' : str})
...
print("Writing data")
joined_data.to_csv('global_data_2019_to_2023_processed.zip', index=False)


# In[ ]:
joined_data[joined_data["date"].dt.year == 2023].to_parquet('global_data_2023only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2022].to_parquet('global_data_2022only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2021].to_parquet('global_data_2021only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2020].to_parquet('global_data_2020only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2019].to_parquet('global_data_2019only_processed.parquet', index=False)