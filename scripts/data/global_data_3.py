...
global_data = pd.read_csv('global_data_2002_2009.zip', dtype={'priusa': str, 'prican' : str, 'prirow' : str, 'iid' : str})
...
# In[ ]:
joined_data.to_csv('global_data_2005_to_2011_processed.zip', index=False)

# In[ ]:
joined_data[joined_data["date"].dt.year == 2011].to_parquet('global_data_2011only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2010].to_parquet('global_data_2010only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2009].to_parquet('global_data_2009only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2008].to_parquet('global_data_2008only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2007].to_parquet('global_data_2007only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2006].to_parquet('global_data_2006only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2005].to_parquet('global_data_2005only_processed.parquet', index=False)
