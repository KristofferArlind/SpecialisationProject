...
na_data = pd.read_csv('na_data_2007.zip', dtype={'priusa': str, 'prican' : str, 'prirow' : str, 'iid' : str})
...
# In[ ]:
joined_data.to_csv('na_data_2009_to_2023_processed.zip', index=False)

# In[ ]:
joined_data[joined_data["date"].dt.year == 2023].to_parquet('na_data_2023only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2022].to_parquet('na_data_2022only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2021].to_parquet('na_data_2021only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2020].to_parquet('na_data_2020only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2019].to_parquet('na_data_2019only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2018].to_parquet('na_data_2018only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2017].to_parquet('na_data_2017only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2016].to_parquet('na_data_2016only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2015].to_parquet('na_data_2015only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2014].to_parquet('na_data_2014only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2013].to_parquet('na_data_2013only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2012].to_parquet('na_data_2012only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2011].to_parquet('na_data_2011only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2010].to_parquet('na_data_2010only_processed.parquet', index=False)
# In[ ]:
joined_data[joined_data["date"].dt.year == 2009].to_parquet('na_data_2009only_processed.parquet', index=False)
